...
exports.ContinuousScoreFunction = void 0;
...
*/
class ContinuousScoreFunction extends ScoreFunction_1.ScoreFunction {
    // ========================================================================================
    // 									Constructor
    // ========================================================================================
    /*
    ...
    */
    constructor(minDomainValue, maxDomainValue) {
        super();
    ...
    */
    initialize(type) {
        ...
        let min = this.minDomainValue;
        let max = this.maxDomainValue;
        let increment = (max - min) / 4.0;
        // Add three evenly-spaced points between min and max
        if (type === ScoreFunction_1.ScoreFunction.FLAT) {
        ...
        else if (type === ScoreFunction_1.ScoreFunction.POSLIN) {
        ...
        else if (type === ScoreFunction_1.ScoreFunction.NEGLIN) {
            let slope = 1.0 / (max - min);
    ...
    */
    setElementScore(domainElement, score) {
    ...
    */
    ...
    setMinDomainValue(min) {
        this.minDomainValue = min;
    }
    setMaxDomainValue(max) {
    ...
    static linearInterpolation(start, end, elementToInterpolate) {
    ...
    */
    getMemento() {
        ...
        var internalMapCopy = new Map();
        // Copy the internal map values we want to save to the new internal map.
        this.getElementScoreMap().forEach((value, key) => {
...
exports.ContinuousScoreFunction = ContinuousScoreFunction;
//# sourceMappingURL=ContinuousScoreFunction.js.map